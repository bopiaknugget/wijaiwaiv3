...
# Phase 03 — Disable Notes and Web Scraping Active Scope

Hide/remove Notes and Web from active UI and routing.

Required:
- hide Notes tab
- hide Web tab
- stop note/web ingestion into Pinecone
- remove active `web_scraper` import if safe
- keep legacy functions only for compatibility
