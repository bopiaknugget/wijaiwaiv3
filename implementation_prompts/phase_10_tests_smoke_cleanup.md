...
# Phase 10 — Tests, Smoke Checks, Cleanup

Add minimal tests/smoke checks:
- SQLite v3 table init
- OpenAlex normalization sample
- citation rendering `[author_name, paper_name]`
- unknown citation ID rejected
- metadata-only paper not used as full-text evidence
- app imports

Clean only obvious active references to Notes/Web if safe.
