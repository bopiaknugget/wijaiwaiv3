...
# Phase 04 — Docling Ingestion Pipeline

Introduce Docling-based ingestion for Reference Vault uploads.

Required:
- convert uploaded PDF/scanned PDF to Markdown
- save original and Markdown paths
- update SQLite document status processing/active/failed
- pass Markdown result forward for LlamaIndex
- keep old parser as fallback only if needed
